...
globalkeys = gears.table.join(
	...
	end, { description = "Foco aplicacion izquierda", group = "client" }),
	awful.key({ modkey }, "Right", function()
		awful.client.focus.byidx(-1)
	end, { description = "Foco Aplicacion derecha", group = "client" }),
	...
	end, { description = "swap ventanas", group = "client" }),
	...
	end, { description = "Aumentar tamaño ventana enfocada horizontalmente", group = "layout" }),
	awful.key({ modkey }, "h", function()
		awful.tag.incmwfact(-0.05)
	end, { description = "Reduce tamaño ventana enfocada horizontalmente", group = "layout" }),
	...
	end, { description = "Pantallazo recortado", group = "screenshot" }),
	awful.key({ modkey, "Shift" }, "w", function()
		awful.util.spawn('bash -c "maim -st 9999999 -b 2 --hidecursor | xclip -selection clipbard -t image/png"')
	end, { description = "Pantallazo select window", group = "screenshot" }),
	awful.key({ modkey, "Shift" }, "space", function()
		awful.layout.inc(-1)
	end, { description = "Cambiar layout activo", group = "layout" }),
	...
	end, { description = "Restaurar minimizado", group = "client" }),
